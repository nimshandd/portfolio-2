...
function ProjectCard({ project }) {
  ...
  return (
    <div className="bg-[#161616] border border-[#27272A] rounded-xl overflow-hidden flex flex-col group hover:border-[#A1A1AA] transition-all duration-300">
      {/* Image container */}
      ...
      <div className="p-6 flex flex-col flex-grow text-left space-y-4">
        ...
        <div className="flex items-center gap-4 pt-4 mt-auto border-t border-[#27272A]/50">
          <a
            ...
            className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#A1A1AA] hover:text-white transition-colors duration-200"
          >
            <FiGithub size={16} />
            Code
          </a>
          ...
          {hasLiveUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#A1A1AA] hover:text-[#A855F7] transition-colors duration-200"
            >
