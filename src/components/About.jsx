      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="md:col-span-2 space-y-6 text-left">
            ...
            <div className="p-6 bg-[#161616] border border-[#27272A] rounded-xl space-y-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="p-6 bg-[#161616] border border-[#27272A] rounded-xl text-left space-y-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 bg-[#161616] border border-[#27272A] rounded-xl text-left space-y-1">
